...
<body>
    <div class="container py-4">
        ...
        <div class="hero-section text-center">
            <div class="container">
                <div class="mb-4">
                    <img src="{{ asset('images/mdkk_logo.jpg') }}" alt="MDKK Logo" class="img-fluid" style="max-height: 180px; width: auto;">
                </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card text-center h-100 border-0 shadow-sm">
                    <div class="card-body py-5">
                        ...
                        <a href="{{ route('bookings.create') }}" class="btn btn-success btn-lg mt-3">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card text-center h-100 border-0 shadow-sm">
                        <div class="card-body py-5">
                            ...
                            <a href="{{ route('admin.bookings.index') }}" class="btn btn-warning btn-lg mt-3 text-white">
