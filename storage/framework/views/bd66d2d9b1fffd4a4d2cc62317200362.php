            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white active" href="<?php echo e(route('admin.bookings.index')); ?>">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                            Ditolak</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['cancelled'] ?? 0); ?></div>
                                    </div>
                                    <div class="col-auto">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <strong><?php echo e($booking->organizer_name); ?></strong><br>
                                                    <small class="text-muted"><?php echo e($booking->organization); ?></small>
                                                </td>
                                                <td><?php echo e($booking->hall->name ?? 'N/A'); ?></td>
                                                <td>
                                                    <?php echo e(\Carbon\Carbon::parse($booking->start_at)->format('d/m/Y')); ?><br>
                                                    <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($booking->start_at)->format('H:i')); ?></small>
                                                </td>
                                                <td>
                                                    <?php echo e(\Carbon\Carbon::parse($booking->end_at)->format('d/m/Y')); ?><br>
                                                    <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($booking->end_at)->format('H:i')); ?></small>
                                                </td>
                                                <td><?php echo e($booking->purpose ?? 'N/A'); ?></td>
                                                <td>
                                                    <span class="badge bg-<?php echo e($booking->status == 'confirmed' ? 'success' : ($booking->status == 'pending' ? 'warning' : 'danger')); ?>">
                                                        <?php echo e($booking->status == 'confirmed' ? 'Lulus' : ($booking->status == 'pending' ? 'Menunggu' : 'Ditolak')); ?>
...
<?php /**PATH C:\laragon\www\HallReservationMDKK\resources\views/admin/bookings/index.blade.php ENDPATH**/ ?>