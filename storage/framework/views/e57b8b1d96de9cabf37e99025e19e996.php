            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link text-white active" href="<?php echo e(route('admin.dashboard')); ?>">
                                <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="<?php echo e(route('admin.bookings.index')); ?>">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($approvedBookings); ?></div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                            Ditolak</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($rejectedBookings); ?></div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <a href="<?php echo e(route('admin.bookings.index')); ?>" class="btn btn-outline-success btn-lg w-100">
                                            <i class="fas fa-tasks me-2"></i>Urus Semua Tempahan
                                        </a>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <a href="<?php echo e(route('admin.bookings.index')); ?>?status=pending" class="btn btn-outline-warning btn-lg w-100">
                                            <i class="fas fa-clock me-2"></i>Lihat Menunggu Kelulusan
                                        </a>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <a href="<?php echo e(route('bookings.create')); ?>" class="btn btn-outline-primary btn-lg w-100">
...
<?php /**PATH C:\laragon\www\HallReservationMDKK\resources\views/admin/dashboardAdmin.blade.php ENDPATH**/ ?>